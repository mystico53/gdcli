# Condition C: Bare LLM (no MCP tools)

## Setup
1. Create a fresh directory: `benchmark/runs/bare-N/`
2. Start Claude Code with NO MCP servers configured, CWD set to the run directory
...
Write all files directly (.tscn, .gd, project.godot).
