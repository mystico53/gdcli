# Hard Benchmark — Condition A: gdcli MCP

## Setup
1. Create: `benchmark/runs/hard-gdcli-N/`
2. Claude Code with gdcli MCP, CWD = run dir
3. Note start time
...
Build a Godot 4 2D arena game project using gdcli MCP tools. Do not write .tscn files directly.
...
Modify the project using gdcli MCP tools:
